...
$string['certificatehistory'] = 'Certificate history';
$string['certificatehistory_desc'] = 'Archived certificate history for {$a}:';
$string['viewcerthistory'] = 'View ({$a})';
$string['nocertificatehistory'] = 'No archived certificates found for this user.';
$string['certificatename'] = 'Certificate name';
$string['originalissuedate'] = 'Original issue date';
$string['archiveddate'] = 'Archived date';
$string['deletedcertificate'] = '(Deleted certificate)';
$string['privacy:metadata:local_recompletion_cert'] = 'Archive of previous certificate issues.';
$string['privacy:metadata:local_recompletion_cert:customcertid'] = 'The ID of the certificate.';
$string['privacy:metadata:local_recompletion_cert:timecreated'] = 'The time that the certificate was originally issued.';
$string['privacy:metadata:local_recompletion_cert:timearchived'] = 'The time that the certificate was archived.';