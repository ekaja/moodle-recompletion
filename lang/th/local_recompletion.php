...
$string['certificatehistory'] = 'Certificate เก่า';
$string['certificatehistory_desc'] = 'ประวัติ Certificate ของ {$a}:';
$string['viewcerthistory'] = 'ดู ({$a})';
$string['nocertificatehistory'] = 'ไม่พบ Certificate ที่เก็บไว้สำหรับผู้ใช้นี้';
$string['certificatename'] = 'ชื่อ Certificate';
$string['originalissuedate'] = 'วันที่ออกเดิม';
$string['archiveddate'] = 'วันที่เก็บ';
$string['deletedcertificate'] = '(Certificate ที่ถูกลบ)';
$string['privacy:metadata:local_recompletion_cert'] = 'ข้อมูล Certificate ที่เก็บไว้';
$string['privacy:metadata:local_recompletion_cert:customcertid'] = 'รหัส Certificate';
$string['privacy:metadata:local_recompletion_cert:timecreated'] = 'เวลาที่ออก Certificate เดิม';
$string['privacy:metadata:local_recompletion_cert:timearchived'] = 'เวลาที่เก็บ Certificate';
